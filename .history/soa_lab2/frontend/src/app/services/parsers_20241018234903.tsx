...
export function parseFlatFromXml(xmlResponse: string): Flat {
  ...
  const flat: Flat = {
    ...
    coordinates: {
      ...
      y: parseFloat(xmlDoc.getElementsByTagName('y')[0].textContent || ''),
    },
    ...
    numberOfRooms: parseInt(xmlDoc.getElementsByTagName('numberOfRooms')[0].textContent || ''),
    ...
    house: {
      ...
      year: parseInt(xmlDoc.getElementsByTagName('house')[0].getElementsByTagName('year')[0].textContent || ''),
      numberOfFloors: parseInt(xmlDoc.getElementsByTagName('house')[0].getElementsByTagName('numberOfFloors')[0].textContent || ''),
      numberOfLifts: parseInt(xmlDoc.getElementsByTagName('house')[0].getElementsByTagName('numberOfLifts')[0].textContent || ''),
    },
  };
