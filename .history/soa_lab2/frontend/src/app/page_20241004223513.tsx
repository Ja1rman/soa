    ...
    if (editFormData) {
      try {
        ...
        const updatedFlat: Flat = {
          ...
          furnish: xmlDoc.getElementsByTagName('furnish')[0].textContent as Furnish : undefined,
          view: xmlDoc.getElementsByTagName('view')[0].textContent || 'NONE',
          transport: xmlDoc.getElementsByTagName('transport')[0].textContent ,
          house: {
