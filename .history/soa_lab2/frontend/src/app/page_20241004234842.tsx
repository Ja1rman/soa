...
`}</style>
      <form onSubmit={handleAddFlat}>
        ...
        <select
          id="view"
          value={addView}
          onChange={(e) => setAddView(e.target.value as Furnish)}
        >
          <option value="">Select View</option>
          <option value="YARD">DESIGNER</option>
          <option value="PARK">NONE</option>
          <option value="NORMAL">FINE</option>
          <option value="GOOD">BAD</option>
        </select>
        <select
          id="transport"
          value={addTransport}
          onChange={(e) => setAddTransport(e.target.value as Furnish)}
        >
          <option value="">Select Transport</option>
          <option value="YARD">FEW</option>
          <option value="PARK">NONE</option>
          <option value="NORMAL">FINE</option>
          <option value="GOOD">BAD</option>
        </select>
